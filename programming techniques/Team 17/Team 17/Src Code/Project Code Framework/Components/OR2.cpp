...
void OR2::Draw(Output* pOut, bool selected_arg)
{
	//Call output class and pass gate drawing info to it.
	pOut->DrawOR2(m_GfxInfo, selected_arg);
}
...
Location OR2::getInputPin1tLocation()
{
...
Location OR2::getoutputPinLocation()
{
	return outputpin;
}
...
void OR2::setINputPin_1_Reserved()
{
	inputPin1_reserved = true;
}
void OR2::setINputPin_2_Reserved()
{
	inputPin2_reserved = true;
}

void OR2::setINputPin_3_Reserved()
{
}

void OR2::setINputPin_1_Unreserved()
{
	inputPin1_reserved = false;
}
void OR2::setINputPin_2_Unreserved()
{
	inputPin2_reserved = false;
}

void OR2::setINputPin_3_Unreserved()
{
}

void OR2::connectTo(Component* gate_1, int x)
{
	if (x == 0)
	{
		gate_12 = gate_1;
...
Component* OR2::GetGate12() const {
	return gate_12;
}

Component* OR2::GetGate22() const {
	return gate_22;
}
Component* OR2::GetGate33() const {
	return NULL;
}
