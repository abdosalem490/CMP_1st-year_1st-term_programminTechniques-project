...
Location AND2::getInputPin1tLocation()
{
...
Location AND2::getoutputPinLocation()
{
	return outputpin;
}

int AND2::getReserved()
{
	if (inputPin1_reserved == false)
	{
		return 0;
...
void AND2::connectTo(Component* gate_1, int x)
{
	if (x == 0)
	{
		gate_12 = gate_1;
...
string AND2::name() const
{
	return typeid(*this).name();
}

void AND2::setINputPin_1_Reserved()
{
	inputPin1_reserved = true;
}
void AND2::setINputPin_2_Reserved()
{
	inputPin2_reserved = true;
}

void AND2::setINputPin_3_Reserved()
{
}

void AND2::setINputPin_1_Unreserved()
{
	inputPin1_reserved = false;
}
void AND2::setINputPin_2_Unreserved()
{
	inputPin2_reserved = false;
}

void AND2::setINputPin_3_Unreserved()
{
}


Component* AND2::GetGate12() const {
	return gate_12;
}

Component* AND2::GetGate22() const {
	return gate_22;
}
Component* AND2::GetGate33() const {
	return NULL;
}
